...
public class ObjectMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("obj와 obj1는 같은가? : " + isEqual);
		
		//hashcode() 메서드를 사용하여 객체의 해시코드 출력
		...
		System.out.println("obj클래스 " + classOfObj1.getName());
		System.out.println("obj2클래스 " + classOfObj2.getName());
	}
