...
public class UDPClient {
	...
	public void start() throws Exception { // throws는 매서드 뒤에서 가능
		// 소켓을 생성 > 소켓을 통해 UDP 통신이 이루어진다
		DatagramSocket dataSocket = new DatagramSocket();
		// 서버에 연결하기 위해 소켓을 생성..
		// 127.0.0.1 = localhost(내 위치에 있는 ip) > 
		//			   클라이언트와 서버가 같은 컴퓨터에서 실행 중인 것으로 가정
